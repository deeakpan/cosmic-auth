...
async function getAccessToken() {
    ...
    const response = await (0, node_fetch_1.default)(`${authUrl}/oauth/token`, {
        method: 'POST',
        headers: {
...
async function generatePassword(options = {}) {
    const { length = 16, includeUppercase = true, includeLowercase = true, includeNumbers = true, includeSymbols = true, } = options;
    const token = await getAccessToken();
    const response = await (0, node_fetch_1.default)('https://op.spacecomputer.io/api/v1/services/trng', {
        method: 'GET',
        headers: {
